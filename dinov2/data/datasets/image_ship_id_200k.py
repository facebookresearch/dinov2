...
class ImageShipID_200k(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "ImageShipID_200k.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == ImageShipID_200k.Split.TEST:
            dataset = None
