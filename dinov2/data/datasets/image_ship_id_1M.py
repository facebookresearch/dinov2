...
class ImageShipID_1M(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "ImageShipID_1M.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == ImageShipID_1M.Split.TEST:
            dataset = None
