...
class ScaleKDAdaptive(nn.Module):
    def __init__(self,
                 name,
                 use_this,
                 alpha,
        ...
        self.channel_weights = nn.Parameter(torch.ones(teacher_dims))
        self.spatial_weights = nn.Parameter(torch.ones(query_hw[0], query_hw[1]))
    ...
    def forward(self,
        ...
        return {'spatial_loss': spat_loss, 'frequency_loss': freq_loss, 'cosine_similarity': similarity}
