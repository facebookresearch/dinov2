...
class THEOPOULA(Optimizer):
    ...
    def __init__(self, params, lr=1e-2, eta=0, beta=1e14, r=0, eps=1e-8, weight_decay=0):
...
class THEOPOULA_REPLICA(Optimizer):
    def __init__(self, params, lr=1e-2, eta=0, betas=None, r=0, eps=1e-8, weight_decay=0):
        """
        Args:
